...
# ACDS 18.1 625 win32 2023.05.18.18:05:00
# ----------------------------------------
...
# ----------------------------------------
# If clk10m_200m is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clk10m_200m"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clk10m_200m.vo"
}
