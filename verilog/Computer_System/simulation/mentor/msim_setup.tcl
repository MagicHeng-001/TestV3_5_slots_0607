...
# ----------------------------------------
# ACDS 18.1 625 win32 2023.01.06.16:24:11
...
ensure_lib                                       ./libraries/Rx_irq/                               
vmap       Rx_irq                                ./libraries/Rx_irq/                               
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_2_router_001.sv"                        -L altera_common_sv_packages -work router_001                           
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                          -L altera_common_sv_packages -work JTAG_to_FPGA_Bridge_master_agent     
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                     -L altera_common_sv_packages -work JTAG_to_FPGA_Bridge_master_translator
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Rx_irq.v"                                                                            -work Rx_irq                               
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Interval_Timer.v"                                                                    -work Interval_Timer                       
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L border -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L ARM_A9_HPS_f2h_axi_slave_agent -L rsp_mux_002 -L rsp_demux_002 -L cmd_mux_002 -L cmd_demux_002 -L router_005 -L router_003 -L router_002 -L JTAG_to_FPGA_Bridge_master_agent -L JTAG_to_FPGA_Bridge_master_translator -L avalon_st_adapter -L fifo_HPS_to_FPGA_in_rsp_width_adapter -L fifo_HPS_to_FPGA_in_burst_adapter -L ARM_A9_HPS_h2f_axi_master_wr_limiter -L fifo_HPS_to_FPGA_in_agent -L ARM_A9_HPS_h2f_axi_master_agent -L fifo_HPS_to_FPGA_in_translator -L reset_from_locked -L sys_pll -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L fifo -L timing_adt -L jtag_phy_embedded_in_jtag_master -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper_001 -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L fifo_FPGA_to_HPS -L System_PLL -L Slider_Switches -L Rx_irq -L Pushbuttons -L Onchip_SRAM -L LEDs -L JTAG_to_FPGA_Bridge -L Interval_Timer -L HEX5_HEX4 -L HEX3_HEX0 -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L border -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L ARM_A9_HPS_f2h_axi_slave_agent -L rsp_mux_002 -L rsp_demux_002 -L cmd_mux_002 -L cmd_demux_002 -L router_005 -L router_003 -L router_002 -L JTAG_to_FPGA_Bridge_master_agent -L JTAG_to_FPGA_Bridge_master_translator -L avalon_st_adapter -L fifo_HPS_to_FPGA_in_rsp_width_adapter -L fifo_HPS_to_FPGA_in_burst_adapter -L ARM_A9_HPS_h2f_axi_master_wr_limiter -L fifo_HPS_to_FPGA_in_agent -L ARM_A9_HPS_h2f_axi_master_agent -L fifo_HPS_to_FPGA_in_translator -L reset_from_locked -L sys_pll -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L fifo -L timing_adt -L jtag_phy_embedded_in_jtag_master -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper_001 -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L fifo_FPGA_to_HPS -L System_PLL -L Slider_Switches -L Rx_irq -L Pushbuttons -L Onchip_SRAM -L LEDs -L JTAG_to_FPGA_Bridge -L Interval_Timer -L HEX5_HEX4 -L HEX3_HEX0 -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
