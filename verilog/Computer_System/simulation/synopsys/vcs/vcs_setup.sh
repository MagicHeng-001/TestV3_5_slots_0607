...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_2_router_001.sv \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_Rx_irq.v \
  ...
  $QSYS_SIMDIR/submodules/Computer_System_Interval_Timer.v \
