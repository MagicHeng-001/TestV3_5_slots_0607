...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_2_router_001.sv"                        -work router_001                            -cdslib ./cds_libs/router_001.cds.lib                           
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                          -work JTAG_to_FPGA_Bridge_master_agent      -cdslib ./cds_libs/JTAG_to_FPGA_Bridge_master_agent.cds.lib     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                     -work JTAG_to_FPGA_Bridge_master_translator -cdslib ./cds_libs/JTAG_to_FPGA_Bridge_master_translator.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Rx_irq.v"                                               -work Rx_irq                                -cdslib ./cds_libs/Rx_irq.cds.lib                               
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Interval_Timer.v"                                       -work Interval_Timer                        -cdslib ./cds_libs/Interval_Timer.cds.lib                       
