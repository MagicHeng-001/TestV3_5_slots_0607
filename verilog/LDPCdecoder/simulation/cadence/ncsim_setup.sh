...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_ldpc_pkg.sv"           -work dec_msa -cdslib ./cds_libs/dec_msa.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_ldpc_wimedia_mat.sv"   -work dec_msa -cdslib ./cds_libs/dec_msa.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_ldpc_wimedia_msa.sv"   -work dec_msa -cdslib ./cds_libs/dec_msa.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/LDPCdecoder_ldpc_0_decoder.v" -work decoder -cdslib ./cds_libs/decoder.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/LDPCdecoder_ldpc_0.v"         -work ldpc_0  -cdslib ./cds_libs/ldpc_0.cds.lib 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/LDPCdecoder.v"                                                                           
fi
